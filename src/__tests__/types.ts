...
describe('Vector creation', () => {
  test('Returns a Tuple with last component 0', () => {
    ...
    expect(v).toEqual(Tuple(1, 2, 3, 0));
  });
});
...
describe('Point creation', () => {
  test('Returns a Tuple with last component 1', () => {
    const v = Point(1, 2, 3);
    expect(v).toEqual(Tuple(1, 2, 3, 1));
  });
});
...
describe('Map Tuple', () => {
  ...
  test('Double', () => {
    ...
    expect(mapTuple(double)(a)).toEqual(Tuple(2, 4, 6, 8));
  });
});

describe('Tuple operations', () => {
  const a = Tuple(10, 20, 0, 0),
    b = Tuple(1, 2, 0, 0);

  test('add', () => expect(add(a, b)).toEqual(Tuple(11, 22, 0, 0)));
  test('sub', () => expect(sub(a, b)).toEqual(Tuple(9, 18, 0, 0)));
  test('mul', () => expect(mul(a, b)).toEqual(Tuple(10, 40, 0, 0)));
  test('div', () => expect(div(a, b)).toEqual(Tuple(10, 10, NaN, NaN)));
  test('neg', () => expect(neg(a)).toEqual(Tuple(-10, -20, -0, -0)));
  test('smul', () => expect(smul(a, 2)).toEqual(Tuple(20, 40, 0, 0)));
  test('neg', () => expect(sdiv(a, 2)).toEqual(Tuple(5, 10, 0, 0)));
  test('magnitude', () => expect(magnitude(Tuple(0, 0, 0, 0))).toEqual(0));
